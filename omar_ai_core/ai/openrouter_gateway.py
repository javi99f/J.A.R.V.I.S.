...
import requests
from omar_ai_core.settings import require_secret
...
def _load_api_key() -> str:
    try:
        return require_secret("OPENROUTER_API_KEY")
...
class OpenRouterClient:
    ...
    def __init__(self) -> None:
        ...
        self._headers = {
            ...
            "HTTP-Referer":  "https://github.com/omar-ai-core",
            "X-Title":       "Omar AI Core",
        }
    ...
    def _set_rate_limited(self, model: str) -> None:
    ...
    def chat(
        ...
        prompt: str,
        system: str = (
            "You are a component of Omar AI Core, a private Raspberry Pi assistant. "
...
if __name__ == "__main__":
    print("=" * 55)
    print("  Omar AI Core - OpenRouter Client Self-Test")
    print("=" * 55)
    ...
    try:
        history = [
            ...
            {"role": "user",      "content": "My name is Omar."},
            {"role": "assistant", "content": "Hello Omar, how can I help you?"},
